...
echo -e "\e[00;33m║\e[00m\e[01;32m\t\t\t   PLEASE WAIT :)\t\t\t    \e[00m\e[00;33m║\e[00m"
echo -e "\e[00;33m║\t\t\t\t\t\t\t\t\t    ║\e[00m"
echo -e "\e[00;33m╚═══════════════════════════════════════════════════════════════════════════╝\e[00m"
echo -e ""
echo -e "";
...
if [ $len -eq 0 ]
then
	echo -e "\e[00;33m[\e[00m \e[01;31m+\e[00m \e[00;33m] seems this host has no establshed connections yet\e[00m";
	exit;
fi
...
echo -e "\n\e[00;33m[\e[00m \e[01;32m+\e[00m \e[00;33m] \e[01;32mFIndings: \e[00m"
...
do
	...
	then
		echo -e "╠═══════════════════════════════════════════════════════════════════════════╣";		
		echo -e "║\t\t      \e[01;31mNOARP setted! Ping sweep\e[00m\t\t\t    ║";
		echo -e "╠═════════════════╦═══════════════════╦══════════════════╦══════════════════╣";
	 ...
	 do
	  ...
	  do
	   ...
	   do
			...
			# The operating systems on the network
			...
			# Discovering open ports available 
